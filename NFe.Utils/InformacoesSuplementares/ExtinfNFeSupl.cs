    ...
    public static class ExtinfNFeSupl
    {
        ...
        private static List<EnderecoConsultaPublicaNfce> CarregarUrls()
        {
            var endQrCodeNfce = new List<EnderecoConsultaPublicaNfce>
            {
                ...
                new EnderecoConsultaPublicaNfce(Estado.CE, TipoAmbiente.taProducao, TipoUrlConsultaPublica.UrlQrCode, "http://nfce.sefaz.ce.gov.br/pages/ShowNFCe.html"),
                new EnderecoConsultaPublicaNfce(Estado.CE, TipoAmbiente.taProducao, TipoUrlConsultaPublica.UrlConsulta, "http://nfce.sefaz.ce.gov.br/pages/consultaChaveAcesso.jsf"),
                new EnderecoConsultaPublicaNfce(Estado.CE, TipoAmbiente.taHomologacao, TipoUrlConsultaPublica.UrlQrCode, "http://nfceh.sefaz.ce.gov.br/pages/ShowNFCe.html"),
                new EnderecoConsultaPublicaNfce(Estado.CE, TipoAmbiente.taHomologacao, TipoUrlConsultaPublica.UrlConsulta, "http://nfceh.sefaz.ce.gov.br/pages/consultaChaveAcesso.jsf"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.GO, TipoAmbiente.taProducao, TipoUrlConsultaPublica.UrlConsulta, "http://nfe.sefaz.go.gov.br/nfeweb/sites/nfce/danfeNFCe"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.GO, TipoAmbiente.taHomologacao, TipoUrlConsultaPublica.UrlConsulta, "http://homolog.sefaz.go.gov.br/nfeweb/sites/nfce/danfeNFCe"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.MS, TipoAmbiente.taProducao, TipoUrlConsultaPublica.UrlConsulta, "http://www.dfe.ms.gov.br/nfce"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.MS, TipoAmbiente.taHomologacao, TipoUrlConsultaPublica.UrlConsulta, "http://www.dfe.ms.gov.br/nfce"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.PA, TipoAmbiente.taProducao, TipoUrlConsultaPublica.UrlQrCode, "https://appnfc.sefa.pa.gov.br/portal/view/consultas/nfce/nfceForm.seam"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.PB, TipoAmbiente.taHomologacao, TipoUrlConsultaPublica.UrlQrCode, "http://www.receita.pb.gov.br/nfcehom"),
                new EnderecoConsultaPublicaNfce(Estado.PB, TipoAmbiente.taHomologacao, TipoUrlConsultaPublica.UrlConsulta, "http://www.receita.pb.gov.br/nfcehom"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.RN, TipoAmbiente.taHomologacao, TipoUrlConsultaPublica.UrlConsulta, "http://hom.nfce.set.rn.gov.br/portalDFE/NFCe/ConsultaNFCe.aspx"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.SE, TipoAmbiente.taProducao, TipoUrlConsultaPublica.UrlConsulta, "http://www.nfce.se.gov.br/portal/consultarNFCe.jsp"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.SE, TipoAmbiente.taHomologacao, TipoUrlConsultaPublica.UrlConsulta, "http://www.hom.nfe.se.gov.br/portal/consultarNFCe.jsp"),
                ...
                new EnderecoConsultaPublicaNfce(Estado.SP, TipoAmbiente.taHomologacao, TipoUrlConsultaPublica.UrlConsulta, "https://www.homologacao.nfce.fazenda.sp.gov.br/NFCeConsultaPublica"),
