...
namespace NFe.Wsdl.AdmCsc
{
    ...
    public class NfceCsc4 : SoapHttpClientProtocol, INfeServico4
    {
        public NfceCsc4(string url, X509Certificate certificado, int timeOut)
        {
        ...
        [return: XmlElement("cscNFCeResult", Namespace = "http://www.portalfiscal.inf.br/nfe", ElementName = "nfeResultMsg")]
