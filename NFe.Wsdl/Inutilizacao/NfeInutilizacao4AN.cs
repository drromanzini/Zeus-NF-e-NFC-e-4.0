...
namespace NFe.Wsdl.Inutilizacao
{
    ...
    public class NfeInutilizacao4AN : SoapHttpClientProtocol, INfeServico4
    {
        public NfeInutilizacao4AN(string url, X509Certificate certificado, int timeOut)
        {
        ...
        [return: XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4")]
