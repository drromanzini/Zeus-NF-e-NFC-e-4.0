...
namespace NFe.Wsdl.Inutilizacao
{
    ...
    public class NfeInutilizacao4 : SoapHttpClientProtocol, INfeServico4
    {
        ...
        [return: XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4", ElementName = "nfeResultMsg")]
