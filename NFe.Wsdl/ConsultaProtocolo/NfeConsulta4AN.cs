...
{
    [WebServiceBinding(Name = "NfeConsulta4Soap12", Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeConsultaProtocolo4")]
    public class NfeConsulta4AN : SoapHttpClientProtocol, INfeServico4
    {
        public NfeConsulta4AN(string url, X509Certificate certificado, int timeOut)
        {
        ...
        [return: XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeConsultaProtocolo4")]
