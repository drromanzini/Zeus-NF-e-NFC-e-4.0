...
namespace NFe.Wsdl.ConsultaProtocolo
{
    ...
    public class NfeConsulta4 : SoapHttpClientProtocol, INfeServico4
    {
        ...
        [return: XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeConsultaProtocolo4", ElementName = "nfeResultMsg")]
