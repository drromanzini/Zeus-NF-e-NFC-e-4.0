...
namespace NFe.Wsdl.Autorizacao
{
    ...
    public class NfeAutorizacao4 : SoapHttpClientProtocol, INfeServicoAutorizacao4
    {
        ...
        [return: XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4", ElementName = "nfeResultMsg")]
