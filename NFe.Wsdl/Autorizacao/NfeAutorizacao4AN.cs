...
namespace NFe.Wsdl.Autorizacao
{
    ...
    public class NfeAutorizacao4AN : SoapHttpClientProtocol, INfeServicoAutorizacao4
    {
        ...
        [return: XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4")]
