...
namespace NFe.Wsdl.Autorizacao
{
    ...
    public class NfeRetAutorizacao4AN : SoapHttpClientProtocol, INfeServico4
    {
        ...
        [return: XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4", ElementName = "nfeRetAutorizacaoLoteResult")]
