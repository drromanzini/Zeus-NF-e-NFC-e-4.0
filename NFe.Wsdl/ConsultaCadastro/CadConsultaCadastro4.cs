...
namespace NFe.Wsdl.ConsultaCadastro
{
    ...
    public class CadConsultaCadastro4 : SoapHttpClientProtocol, INfeServico4
    {
        ...
        [return: XmlElement("consultaCadastroResult", Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4", ElementName = "nfeResultMsg")]
