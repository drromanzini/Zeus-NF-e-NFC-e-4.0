...
{
    [WebServiceBinding(Name = "CadConsultaCadastro4Soap", Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4")]
    public class CadConsultaCadastro4AN : SoapHttpClientProtocol, INfeServico4
    {
        public CadConsultaCadastro4AN(string url, X509Certificate certificado, int timeOut)
        {
        ...
        [return: XmlElement("consultaCadastroResult", Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4")]
