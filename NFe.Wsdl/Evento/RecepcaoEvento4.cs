...
{
    [WebServiceBinding(Name = "RecepcaoEvento4Soap12", Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4")]
    public class RecepcaoEvento4 : SoapHttpClientProtocol, INfeServico4
    {
