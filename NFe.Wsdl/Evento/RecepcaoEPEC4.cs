...
{
    [WebServiceBinding(Name = "RecepcaoEPEC4Soap12", Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4")]
    public class RecepcaoEPEC4 : SoapHttpClientProtocol, INfeServico4
    {
        public RecepcaoEPEC4(string url, X509Certificate certificado, int timeOut)
        {
        ...
        [return: XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4", ElementName = "nfeResultMsg")]
