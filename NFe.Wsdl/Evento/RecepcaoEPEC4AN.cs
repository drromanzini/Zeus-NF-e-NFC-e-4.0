...
namespace NFe.Wsdl.Evento
{
    ...
    public class RecepcaoEPEC4AN : SoapHttpClientProtocol, INfeServico4
    {
        public RecepcaoEPEC4AN(string url, X509Certificate certificado, int timeOut)
        {
        ...
        [return: XmlElement(Namespace = "http://www.portalfiscal.inf.br/nfe/wsdl/NFeRecepcaoEvento4")]
